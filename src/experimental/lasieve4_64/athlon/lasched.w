     ...
     u32_t *ri,*ij_ptr,*ij_ptr_ub,n1_j,**sched_ptr,fbi_offs,ot;
{
  ...
  if(ot!=0) {
    if(ot==1) return lasched1(ri,ij_ptr,ij_ptr_ub,n1_j,sched_ptr,fbi_offs,ot);
    if(ot==3) return lasched3(ri,ij_ptr,ij_ptr_ub,n1_j,sched_ptr,fbi_offs,ot);
    return lasched2(ri,ij_ptr,ij_ptr_ub,n1_j,sched_ptr,fbi_offs,ot);
    ot_tester=(ot&1)|((ot&2)<<(i_bits-1));
    ot_mask=n_i|1;
  } else return lasched0(ri,ij_ptr,ij_ptr_ub,n1_j,sched_ptr,fbi_offs,ot);
